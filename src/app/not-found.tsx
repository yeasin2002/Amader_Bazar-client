...
const NotFound: FC<NotFoundProps> = ({ ...rest }) => {
  ...
  return (
    <section {...rest} className="bg-white ">
      <div className="container mx-auto grid min-h-screen grid-cols-1 items-center justify-between px-6 py-12 md:grid-cols-2">
        <div>
          ...
          <div className="mt-6 flex items-center gap-x-3">
            ...
            <button
              className="flex  w-1/2 shrink-0 items-center gap-x-2 rounded-lg bg-blue-500 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 hover:bg-blue-600 sm:w-auto dark:bg-blue-600 dark:hover:bg-blue-500"
              onClick={() => router.push("/")}>
